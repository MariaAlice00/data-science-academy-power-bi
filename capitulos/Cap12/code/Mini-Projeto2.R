...
# Limpeza e transformação de dados com Power Query e Liguagem R
...
medias_iris <- summarise(group_by(dados_iris, Species),
                         ...
                         media_pepal_width = mean(Petal.Width))
View(medias_iris)
...
# Tarefa 3 - Construir um gráfico mostrando a relação de duas variáveis numéricas para as 3 categorias de uma
# variável categórica
library(ggplot2)
